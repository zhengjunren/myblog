    ...
    <el-tabs v-model="active"  @tab-click="handleClick">
      <div class="filter-container">
        ...
        <el-button-group>
          ...
          <el-button v-waves class="filter-item" type="success" icon="el-icon-download" :loading="downloadLoading" @click="isError ? downloadErrorLogExcel() : downloadInfoLogExcel()">导出</el-button>
