  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules">
      <el-form-item label="邮件标题" prop="subject">
        ...
        <el-button type="primary" icon="el-icon-s-tools" @click="doConfig">配置</el-button>
      </el-form-item>
      <el-form-item
        v-for="(domain, index) in tos"
        :label="'收件邮箱' + (index === 0 ? '1': index+1)"
        :key="domain.key">
        <el-input v-model="domain.value" style="width: 61.5%"/>
